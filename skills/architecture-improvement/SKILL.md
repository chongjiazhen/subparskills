...
4. Propose smallest deepening change with locality, leverage, migration, and test impact. Use [INTERFACE-DESIGN.md](INTERFACE-DESIGN.md) when alternatives need comparison.
