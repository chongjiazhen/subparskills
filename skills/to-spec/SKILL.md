...
4. Record decisions as interfaces and behavior. Inline a code snippet only where it encodes a decision more precisely than prose (a state machine, schema, or type shape); inline the decision-rich part and note its origin. Leave out file paths and illustrative code - they go stale fast.
